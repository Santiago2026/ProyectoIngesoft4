...
{
    default String calcularVelocidad(String datagrama)
    {
        return calcularVelocidad(datagrama, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String calcularVelocidad(String datagrama, java.util.Map<String, String> context)
    {
        return _iceI_calcularVelocidadAsync(datagrama, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> calcularVelocidadAsync(String datagrama)
    {
        return _iceI_calcularVelocidadAsync(datagrama, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> calcularVelocidadAsync(String datagrama, java.util.Map<String, String> context)
    {
        return _iceI_calcularVelocidadAsync(datagrama, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_calcularVelocidadAsync(String iceP_datagrama, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "calcularVelocidad", null, sync, null);
